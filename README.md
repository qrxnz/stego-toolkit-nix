...
stego-toolkit-nix is a tool inspired by [Dominic Breuker's](https://linkedin.com/in/dominic-breuker?trk=people-guest_people_search-card) `stego-toolkit`. By utilizing nix, stego-toolkit-nix offers greater flexibility, resulting in an improved user experience
